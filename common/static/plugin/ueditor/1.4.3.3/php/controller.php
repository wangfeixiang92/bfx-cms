...
define('QIFANPHP_PATH', $document_root.$web_path);

include QIFANPHP_PATH.'qifanphp'.DIRECTORY_SEPARATOR.'core'.DIRECTORY_SEPARATOR.'class'.DIRECTORY_SEPARATOR.'image.class.php';
