...
<head>
	...
	<title>系统发生错误</title>
	<link rel="Shortcut Icon" href="<?php echo STATIC_URL;?>admin/qifan_admin/images/favicon.ico" />
	<style type="text/css">
...
<div id="container">
	...
	<p class="footer">Powered by <a href="http://www.qifan.co/" target="_blank">QIFANPHP</a> Version <strong><?php echo QIFANPHP_VERSION;?></strong></p>
</div>
