...
qifan_base::load_common('lib/content_form'.EXT, 'admin');
...
class content extends common {
	...
	public function init() {
		...
		$data = $content->order('updatetime DESC')->limit($page->limit())->select();	
	...
	public function edit() {
		...
		if(isset($_POST['dosubmit'])) {
			...
			$tags = D('tag_content')->alias('a')->field('tag')->join('qifancms_tag b ON a.tagid=b.id', 'LEFT')->where(array('modelid'=>$modelid, 'aid'=> $id))->order('id ASC')->select();
