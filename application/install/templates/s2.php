<?php defined('IN_qifancms') or exit('No Define qifancms.'); ?>
<!doctype html>
<html>
<head>
<meta charset="UTF-8" />
...
?>  
        ...
        <tr>
          <td>application/mobile/controller/access_token.php</td>
          <td>
            <?php 
            if(is_writable(SITEDIR.'application/mobile/controller/access_token.php')){
              echo '<span class="correct_span">&radic;</span>可写 ';
            }else{
              echo '<span class="correct_span error_span">&radic;</span>不可写 ';
              $err++;
          ...
          <td>
            <?php 
            if(is_readable(SITEDIR.'application/mobile/controller/access_token.php')){
              echo '<span class="correct_span">&radic;</span>可读 ';
            }else{
              echo '<span class="correct_span error_span">&radic;</span>不可读 ';
              $err++;
        ...
        <tr>
          <td>application/mobile/controller/jsapi_ticket.php</td>
          <td>
            <?php 
            if(is_writable(SITEDIR.'application/mobile/controller/jsapi_ticket.php')){
              echo '<span class="correct_span">&radic;</span>可写 ';
            }else{
              echo '<span class="correct_span error_span">&radic;</span>不可写 ';
              $err++;
          ...
          <td>
            <?php 
            if(is_readable(SITEDIR.'application/mobile/controller/jsapi_ticket.php')){
              echo '<span class="correct_span">&radic;</span>可读 ';
            }else{
              echo '<span class="correct_span error_span">&radic;</span>不可读 ';
              $err++;
        ...
        <tr>
          <td>application/mobile/controller/tx.txt</td>
          <td>
            <?php 
            if(is_writable(SITEDIR.'application/mobile/controller/tx.txt')){
              echo '<span class="correct_span">&radic;</span>可写 ';
            }else{
              echo '<span class="correct_span error_span">&radic;</span>不可写 ';
              $err++;
          ...
          <td>
            <?php 
            if(is_readable(SITEDIR.'application/mobile/controller/tx.txt')){
              echo '<span class="correct_span">&radic;</span>可读 ';
            }else{
              echo '<span class="correct_span error_span">&radic;</span>不可读 ';
              $err++;
        ...
        <tr>
          <td>application/mobile/controller/user.txt</td>
          <td>
            <?php 
            if(is_writable(SITEDIR.'application/mobile/controller/user.txt')){
              echo '<span class="correct_span">&radic;</span>可写 ';
            }else{
              echo '<span class="correct_span error_span">&radic;</span>不可写 ';
              $err++;
          ...
          <td>
            <?php 
            if(is_readable(SITEDIR.'application/mobile/controller/user.txt')){
              echo '<span class="correct_span">&radic;</span>可读 ';
            }else{
              echo '<span class="correct_span error_span">&radic;</span>不可读 ';
              $err++;
