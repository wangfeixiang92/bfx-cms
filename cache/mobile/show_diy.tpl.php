<?php defined('IN_QIFANPHP') or exit('No permission resources.'); ?><html>
	...
	<body>
	<?php if($music) { ?>
	<audio id="music" src="<?php echo $music;?>" autoplay="autoplay" loop="loop"></audio>    
	<a id="audio_btn" style="position: fixed;margin-top: 15px;margin-left: -45px;left: 100%;">
		<img src="<?php echo STATIC_URL;?>images/play.gif" width="35" height="35" id="music_btn" border="0">
	</a>    
	<script>
	  (function() {
  ...
  <script>
	$("#audio_btn").click(function(){
		...
		if(music.paused){    
			music.play();
			$("#music_btn").attr("src","<?php echo STATIC_URL;?>images/play.gif");
		}else{
			music.pause();    
			$("#music_btn").attr("src","<?php echo STATIC_URL;?>images/stop.png");
		}
	});
</script>
<?php } ?>
<div class="page-con" id='click'><?php echo $content;?></div>
