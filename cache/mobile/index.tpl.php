		...
		<div class="container-fluid">
			...
			<div class="row navs">
				<ul class="nav nav-tabs" role="tablist" style="width:100%; " id="navul">
					...
					<a role="presentation" class="active <?php if($v['catid']== 1) { ?>non<?php } ?>" href="<?php echo U('mobile/index/lists','catid='.$v['catid']);?>">
						...
						<div class="row content3">
							<div class=" video-content">
								<table class="table table-striped">
									<tbody>
									<?php $tag = qifan_base::load_sys_class('qifan_tag');if(method_exists($tag, 'lists')) {$data = $tag->lists(array('field'=>'url,id,catid,title,inputtime,click,thumb','catid'=>'1','page'=>'page',));$pages = $tag->pages();}?>
									<?php if(is_array($data)) foreach($data as $v) { ?>
										<tr>
											<td>
